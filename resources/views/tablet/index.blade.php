...
<body>
    ...
    <div class="m-4">
        <div class="item-center bg-gray-800  text-center text-xl mt-3 mb-2 text-white px-6 rounded-lg w-full inline-block">Your Order List</div>
