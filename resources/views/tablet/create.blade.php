    ...
    <div class="container  mt-8">
        <div class="mx-auto  w-full bg-white shadow-lg rounded-lg max-w-md">
            <div class="grid gap-4 p-4 mb-4 bg-gray-900 mx-auto m-6 rounded-lg shadow-lg">
                <p class="text-white items-center text-center bg-gray-500 rounded-lg px-4">Order Here</p>
                <form  action="{{route('tablet.store')}}" method="POST" >
                   ...
                   <div class="mb-2">
                        ...
                        <input class="w-full font-medium rounded-lg" type="text" name="price" id="price">
                  </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input class="w-full font-medium rounded-lg" type="text" name="stock" id="stock">
                    </div>
